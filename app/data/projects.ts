...
const Projects: Project[] = [
	{
		name: "Opal",
		description:
			"Revolutionizing the way that students learn using AI. Used by students from top institutions such as MIT, Harvard, and Stanford.",
		image: "/images/projects/opal.png",
		link: "https://learnopal.com",
		github: null,
	...
	},
	{
		name: "Satorly",
		description:
			"Satorly (Work in progress) is a platform that helps students study for the SAT using AI.",
		image: "/images/projects/satorly.png",
		link: "https://satorly.com",
		github: null,
		tags: ["Next.js", "TypeScript", "Supabase", "AI"],
	},
	{
		name: "Radium",
		description:
			"Create photo-realistic scenes and games with a simple editor and a powerful engine.",
	...
	},
	{
		name: "EcoTrackr",
		description:
			"Track your carbon footprint and make a difference. Built in 48 hours for a hackathon.",
	...
	},
	{
		name: "Graider",
		description:
			"Get a second opinion on your essay, from an AI. Built in 48 hours for a hackathon.",
	...
	},
	{
		name: "TutorTime",
		description:
			"Volunteer as a tutor or get tutored for free in any subject. Built in 48 hours for a hackathon.",
